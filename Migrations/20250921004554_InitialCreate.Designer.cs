...
namespace Lab05WebApiML.Migrations
{
    ...
    [Migration("20250921004554_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Lab05WebApiML.Models.ApplicationRole", b =>
                {
            ...
            modelBuilder.Entity("Lab05WebApiML.Models.ApplicationUserRole", b =>
                {
            ...
            modelBuilder.Entity("Lab05WebApiML.Models.RefreshTokens", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Lab05WebApiML.Models.ApplicationUserRole", b =>
                {
                    b.HasOne("Lab05WebApiML.Models.ApplicationRole", "Role")
                        .WithMany("UserRoles")
                        .HasForeignKey("RoleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Lab05WebApiML.Models.ApplicationUser", "User")
                        .WithMany("UserRoles")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<string>", b =>
                {
                    b.HasOne("Lab05WebApiML.Models.ApplicationRole", null)
                        .WithMany()
                        .HasForeignKey("RoleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Lab05WebApiML.Models.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
